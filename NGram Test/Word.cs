...
namespace lambhootDiscordBot
{
    public class Word
    {
        ...
        public string nextChosenWord(int gn = 0)
        {
            ...
            if (wordAfterLists.Count() < gn && wordAfterLists[gn].Count() == 0)
                return returnString;

            if (wordAfterLists.Count() < gn && wordAfterLists[gn].Count() == 1 && (randomDoubleRange(0, 100) > 50))
            {
                return returnString;
            }
        ...
        public float probabilityGivenSentence(List<Word> currentSentence)
        {
            ...
            return nextWordProb;//TODO *prop_sentence / prob_word
        }
        ...
        {
            float prob = 0;
            if (minWordAfterProbList.Count() < gn)
            {
                prob = (float)randomDoubleRange(minWordAfterProbList[gn] * 0.8, maxWordAfterProbList[gn] * 1.2);
    ...
    public class WordAfter : IComparable<string>
    {//it's about time!
        public string wordString;
